...
if (isset($_POST['submit'])) {
    ...
    $government_ar = $_POST['government_ar'];
    $government_en = $_POST['government_en'];
    print($government_ar);
    print($government_en);
    $sql = "INSERT INTO `cities`(`government_ar` , `government_en`) VALUES ('$government_ar' , '$government_en')";
    if ($conn->query($sql) === False) {
        echo "Error: " . $sql . "<br>" . $conn->error;
    } else {
        echo "<script> window.onload = function(){window.location.href = './city-add.php?messege=1';}</script>";
    }
} else {
                    ...
                    <div class="row gap-20 masonry">
                        ...
                        <div class="masonry-item col-md-8">
                            <div class="bgc-white p-20 bd">
                                ...
                                <div class="mT-30">
                                    <form method="POST" id="form" class="form-horizontal" action="city-add.php">
                                        <section class="panel">
                                            <header class="panel-heading">

                                                <h2 class="panel-title">Add Government</h2>
                                                <div style="width: 50%;display:none;" id="alertAdded" class="alert alert-success" role="alert">Government Created</div>
                                            </header>
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label class="col-sm-6 control-label">Government in Arabic <span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="government_ar" class="form-control" placeholder="مثال : القاهرة" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-6 control-label">Government in English <span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="government_en" class="form-control" placeholder="eg.: cairo" required />
                                                    </div>
                                                </div>
