...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql) === False) {
        ...
        echo "<script> window.onload = function(){window.location.href = './dynamic-numbers-add.php?messege=1';}</script>";
    }
} else {
                    ...
                    <div class="row gap-20 masonry">
                        ...
                        <div class="masonry-item col-md-8">
                            <div class="bgc-white p-20 bd">
                                ...
                                <div class="mT-30">
                                    <form method="POST" id="form" class="form-horizontal" action="dynamic-numbers-add.php">
                                        <section class="panel">
                                            <header class="panel-heading">
                                                <h2 class="panel-title">Add Year Statistics</h2>
                                                <div style="width: 50%;display:none;" id="alertAdded" class="alert alert-success" role="alert">Year Statistics Created</div>
                                            </header>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="years" class="form-control" placeholder="مثال :  2019" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-6 control-label">clients Number<span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="clients" class="form-control" placeholder="eg.: 1000000" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="branches_num" class="form-control" placeholder="eg.:71" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">cities number <span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="cities_num" class="form-control" placeholder="eg.:12" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">years number in arabic<span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="years_ar" class="form-control" placeholder="eg.:12" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">clients number in arabic<span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="clients_ar" class="form-control" placeholder="eg.:12" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="branches_num_ar" class="form-control" placeholder="eg.:12" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="Current_year" class="form-control" placeholder="eg.:12" required />
                                                    </div>
                                                </div>
