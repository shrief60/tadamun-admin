...
<body class="app">
            ...
            <main class='main-content bgc-grey-100'>
                <div id='mainContent'>
                    <div class="container-fluid">
                        <h4 class="c-grey-900 mT-10 mB-30">Admin Governments</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    <h4 class="c-grey-900 mB-20">Governments</h4>
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-sm-6">
                                            <div class="mb-md">
                                                <a href="./city-add.php">
                                                    <button id="addToTable" class="btn btn-primary">Add Government <i class="fa fa-plus"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            if ($posts) {
                                                for ($row = 0; $row < count($posts); $row++) { ?>
                                                    <tr>
                                                        ...
                                                        <td> <?php echo $posts[$row]['government_en']; ?></td>
                                                        <td class="actions">
    ...
    <script>
        ...
        function replace(r) {
            ...
            var tr = table2.getElementsByTagName("tr");
            var td = tr[i].getElementsByTagName("td")[0];
            window.location.href = "./city-edit.php" + "?row=" + td.innerHTML;
        }
    </script>
