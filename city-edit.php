...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `cities` SET `government_ar`='$government_ar', `government_en`='$government_en' WHERE `id`='$row'";
    if ($conn->query($sql) === False) {
        ...
        echo "<script> window.onload = function(){window.location.href = './Admin-cities.php';}</script>";
    }
}
// close connection
mysqli_close($conn);
                                        ...
                                        <section class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Government in Arabic <span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="government_ar" class="form-control" value="<?php echo $posts[$value]['government_ar'] ?>" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Government in English <span class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="government_en" class="form-control" value="<?php echo $posts[$value]['government_en'] ?>" required />
                                                    </div>
                                                </div>
                                            </div>
