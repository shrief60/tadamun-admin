...
$GLOBALS['x'] = '2';
// create EXIST query
$query = 'SELECT  branches.*, cities.government_en,cities.government_ar FROM branches, cities where cities.id = branches.government_id';
//get result
...
if (isset($_POST['confirm'])) {
    $delete = $_POST['delete'];
    //echo $delete ;
    $sql = "DELETE FROM `branches` WHERE id='$delete'";
...
<body class="app">
                        ...
                        <div class="peer peer-greed">
                            <a class="sidebar-link td-n" href="#">
                                <div class="peers ai-c fxw-nw">
                                    ...
                                    <div class="peer peer-greed">
                                        <h5 class="lh-1 mB-0 logo-text">ALTADAMON ADMIN</h5>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            <main class='main-content bgc-grey-100'>
                <div id='mainContent'>
                    <div class="container-fluid">
                        <h4 class="c-grey-900 mT-10 mB-30">Admin Branches</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    <h4 class="c-grey-900 mB-20">Branches</h4>
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-sm-6">
                                            <div class="mb-md">
                                                <a href="./Branch-add.php">
                                                    <button id="addToTable" class="btn btn-primary">Add Branch <i class="fa fa-plus"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            if ($posts) {
                                                for ($row = 0; $row < count($posts); $row++) { ?>
                                                    <tr>
                                                        ...
                                                        <td> <?php echo $posts[$row]['government_ar']; ?></td>
                                                        <td> <?php echo $posts[$row]['name']; ?></td>
                                                        <td> <?php echo $posts[$row]['name_en']; ?></td>
    ...
    <script>
        ...
        function replace(r) {
            ...
            var tr = table2.getElementsByTagName("tr");
            var td = tr[i].getElementsByTagName("td")[0];
            window.location.href = "./Branch-edit.php" + "?row=" + td.innerHTML;
        }
    </script>
